...
public class BusRoute {
    ...
    public String getRouteStartStationName() {
        return routeStartStationName;
    }

    public void setRouteStartStationName(String routeStartStationName) {
    ...
    public String getRouteEndStationName() {
        return routeEndStationName;
    }

    public void setRouteEndStationName(String routeEndStationName) {
