...
class RetrofitInit {
    ...
    var retrofitInit = Retrofit.Builder().baseUrl(SERVER_URL).addConverterFactory(TikXmlConverterFactory.create()).addCallAdapterFactory(RxJava2CallAdapterFactory.create()).build()
